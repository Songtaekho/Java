...
//		System.out.println(str);
		...
		//문자열을 다를 수 있는 여러가지 함수를 제공해줍니다.
		//str 에 . 찍어서 사용함
		
//		//문자열 한글자 자르기 charAt(인덱스번호)
//		System.out.println(str.charAt(0));
		...
		System.out.println(str);    // 2. 원본은 변경안함
		
		//str = str.replace("문자", "word"); // <- 이거는 원본문자도 바꿈		
		...
		String[] arr = str.split("-"); // split은 값을 배열로 받음
		System.out.println( Arrays.toString(arr));
		
		char[] arr2 = str.toCharArray(); //한글자씩 잘라서, char[] 반환
		System.out.println( Arrays.toString(arr2));
		
		//특정문자로 연결하기 String.join(구분자, 배열 or 문자열 나열)
